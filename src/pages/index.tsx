  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of commute with Car Sharing Application - Efficient, Eco-friendly, Economical. Your journey starts here."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of commute with Car Sharing Application - Efficient, Eco-friendly, Economical. Your journey starts here.`}
            </Text>
            <Box
